...
public class LoginDAO {
    ...
    public void setCurrentUserInfo(String id) {
        currentUserId = id;
        currentUserTel = selectUserTel();
    }
    ...
    public String selectUserTel() {
        DBConnection dbConn = DBConnection.getInstance();
        String tel = null;

        try {
            Connection conn = dbConn.getConnection();
            StringBuilder selectQuery = new StringBuilder("select tel from owner where owner_id = ?");
    ...
    public LoginVO selectLoginInfo(String owner_id, String pw) throws SQLException {
        ...
        try {
            ...
            StringBuilder selectLogin =
                    new StringBuilder("select owner_id,pw from owner where owner_id = ? and pw = ?");
