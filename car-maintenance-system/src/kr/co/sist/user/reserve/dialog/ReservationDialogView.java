...
public class ReservationDialogView extends JPanel {
    ...
    private void addCommonView() {
        ...
        jlAM = new JLabel("오전");
        jlPM = new JLabel("오후");
        jlAM.setFont(FontSingleton.getInstance().bonGodic.deriveFont(16f));
        jlPM.setFont(FontSingleton.getInstance().bonGodic.deriveFont(16f));
    ...
    public CommonReservationView getCrv() {
        return crv;
    }
