...
public class MaintenanceProgressDAO {
    ...
    // 부품 정보 추가 메서드
    public void addPartInfo(String carId, String partCode, int partCnt, String partName,
            String maintenanceClassification) throws SQLException {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ...
        try {
            ...
            String insertPartInfoQuery =
                    "INSERT INTO car_maintenance_settlement(CAR_MAINTENANCE_ID, part_code, part_cnt, MAINTENANCE_CLASSIFICATION, maintenance_reason, CAR_MAINTENANCE_DATE, car_id) "
                            + "VALUES (?, ?, ?, ?, ?, ?, ?)";
