...
public class MaintenanceProgressEvent implements ActionListener {
    ...
    public MaintenanceProgressEvent(MaintenanceProgressView view, MaintenanceProgressDAO dao, String carId,
        ...
        currentCarId = carId;
        currentMaintenanceStatus = maintenanceStatus;
    }
    ...
    private void confirmMaintenance() {
        ...
        partsCountMap.forEach((partCode, partCnt) -> {
            try {
                ...
                maintenanceProgressDAO.addPartInfo(currentCarId, partCode, partCnt, partName, currentMaintenanceStatus); // 예시에서 '일반'는
        ...
        maintenanceProgressView.dispose();
    }
    ...
    private void insertPartInfo() {
        ...
        try {
            if (!maintenanceProgressView.getJtfPartCnt().getText().isBlank()) {
